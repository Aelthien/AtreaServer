...
import static atrea.server.game.entities.EInteractableType.*;
...
//        System.out.println(entityAddQueue.size() + " " + System.currentTimeMillis());
    ...
    public Entity createEntity(EInteractableType type, int definitionId) {
